...
for LOOP in range(loop):
    #Wczytanie datasetu
    load_df = pd.read_csv("shampoo.csv", header =0, index_col= 0)
    ...
    train, test = supervised[:24],supervised[24:]
    ...
    #Dopasowanie modelu
    lstm_model = fit_lstm(scaled_train,1,1300,1)
    #print(lstm_model)
    ...
    mape_val = mape(raw_values[-12:],predictions)
    print(mape(raw_values[-12:],predictions))
